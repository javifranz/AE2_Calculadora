...
public class Ventana extends JFrame {
	...
	public Ventana () {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage("paste.png"));
	...
	private void inicializarComponentes() {
		...
		IconImg = new JLabel(new ImageIcon("calculator.png"));
		IconImg.setBounds(10, 10, 80, 20);

		
		
		
		etiquetaNum1 = new JLabel("Número 1");
		etiquetaNum1.setBounds(70, 70, 80, 20);
		...
		botonRes.setBounds(180, 140, 100, 25);
		...
		botonDiv.setBounds(180, 170, 100, 25);
		...
		botonR3.setBounds(180, 200, 100, 25);
